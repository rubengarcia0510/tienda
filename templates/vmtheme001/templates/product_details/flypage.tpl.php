...
<?php  if( $this->get_cfg('showManufacturerLink') ) { $rowspan = 5; } else { $rowspan = 4; } ?>
	  <td width="220" rowspan="<?php echo $rowspan; ?>" valign="top" class="product_image_container"><br/>
	...
	<tr>
	  <td colspan="2" class="ask_seller"><?php echo $ask_seller ?></td>
	</tr>
	<tr>
	...
	<tr>
	  <td class="product_separator" colspan="3"><?php echo $product_type ?></td>
	</tr>
	<tr>
	  <td colspan="3"><br /><?php echo $product_reviews ?></td>
	</tr>
	<tr>
